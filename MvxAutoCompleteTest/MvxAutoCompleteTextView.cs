...
namespace MvxAutoCompleteTest
        ...
        : AutoCompleteTextView
    {
        public MyAutoCompleteTextView(Context context, IAttributeSet attrs)
            : this(context, attrs, new MyFilteringAdapter(context))
        {
		...
		protected MyAutoCompleteTextView(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        public new MyFilteringAdapter Adapter
        {
            get { return base.Adapter as MyFilteringAdapter; }
            set
            {
