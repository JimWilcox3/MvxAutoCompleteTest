...
{
    public class MyAutoCompleteTextViewSelectedObjectTargetBinding
        : MvxPropertyInfoTargetBinding<MyAutoCompleteTextView>
    {
        public MyAutoCompleteTextViewSelectedObjectTargetBinding(object target, PropertyInfo targetPropertyInfo)
